...
class CreateBook extends Component {
    ...
    saveBook = (e) => {
        e.preventDefault();
        let book = { title: this.state.title, publicationYear: this.state.publicationYear,
                        ...
                        <div className='container'>
                            <div>
                                ...
                                <form>
                                    <div className=''>
                                        <label>Titre:</label>
                                        <input placeholder='tittre' name='title'
                                            value={this.state.title} onChange={this.changeTitleHandler} />
                                    </div>
                                    <div className=''>
                                        <label>Année de publication:</label>
                                        <input placeholder='email' name='publicationYear'
